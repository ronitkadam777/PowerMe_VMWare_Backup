...
/**
 * @ngdoc function
 * @name powermeApp.controller:UiGeneralCtrl
 * @description
 * # UiGeneralCtrl
...
angular.module('powermeApp')
  ...
  .controller('TypeaheadCtrl', function($scope, $http) {
    ...
    $scope.getLocation = function(val) {
    	console.log(val);
      return $http.post(environment.apiUri+'/powerme/system/_search ', {"query": {"multi_match": { "query": val,"type": "most_fields","fields": ["reportName","description"],"minimum_should_match": "70%"}}})
      .then(function(response){
    	console.log(response.data);
        return response.data.hits.hits.map(function(item){
          return item._source.reportName;
        });
      });
